...
public class FileMetaDataV30 implements org.apache.thrift.TBase<FileMetaDataV30, FileMetaDataV30._Fields>, java.io.Serializable, Cloneable, Comparable<FileMetaDataV30> {
   ...
   */
  public java.util.Map<java.lang.String,DeltaObjectV30> delta_object_map; // required
  /**
   ...
   * 
   */
  public java.lang.String created_by; // optional
  /**
  ...
  public FileMetaDataV30(
    int version,
    java.util.Map<java.lang.String,DeltaObjectV30> delta_object_map,
  ...
  public FileMetaDataV30(FileMetaDataV30 other) {
    ...
    if (other.isSetDelta_object_map()) {
      java.util.Map<java.lang.String,DeltaObjectV30> __this__delta_object_map = new java.util.HashMap<java.lang.String,DeltaObjectV30>(other.delta_object_map.size());
      for (java.util.Map.Entry<java.lang.String, DeltaObjectV30> other_element : other.delta_object_map.entrySet()) {

        java.lang.String other_element_key = other_element.getKey();
        DeltaObjectV30 other_element_value = other_element.getValue();

        java.lang.String __this__delta_object_map_copy_key = other_element_key;
  ...
  public void putToDelta_object_map(java.lang.String key, DeltaObjectV30 val) {
    if (this.delta_object_map == null) {
      this.delta_object_map = new java.util.HashMap<java.lang.String,DeltaObjectV30>();
    }
   ...
   * Map stores all delta object name and their info *
   */
  public java.util.Map<java.lang.String,DeltaObjectV30> getDelta_object_map() {
   ...
   * Map stores all delta object name and their info *
   */
  public FileMetaDataV30 setDelta_object_map(java.util.Map<java.lang.String,DeltaObjectV30> delta_object_map) {
    this.delta_object_map = delta_object_map;
    return this;
  }
   ...
   * Optional json metadata *
   */
  public FileMetaDataV30 setJson_metadata(java.util.List<java.lang.String> json_metadata) {
   ...
   * 
   */
  public FileMetaDataV30 setCreated_by(java.lang.String created_by) {
   ...
   * User specified properties *
   */
  public FileMetaDataV30 setProperties(java.util.Map<java.lang.String,java.lang.String> properties) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case DELTA_OBJECT_MAP:
      if (value == null) {
        ...
        setDelta_object_map((java.util.Map<java.lang.String,DeltaObjectV30>)value);
      }
      break;
  ...
  public int compareTo(FileMetaDataV30 other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDelta_object_map()).compareTo(other.isSetDelta_object_map());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDelta_object_map()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTimeseries_list()).compareTo(other.isSetTimeseries_list());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTimeseries_list()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("FileMetaDataV30(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.delta_object_map = new java.util.HashMap<java.lang.String,DeltaObjectV30>(2*_map72.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.json_metadata = new java.util.ArrayList<java.lang.String>(_list79.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map82.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FileMetaDataV30 struct) throws org.apache.thrift.TException {
      ...
      if (struct.delta_object_map != null) {
        oprot.writeFieldBegin(DELTA_OBJECT_MAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, DeltaObjectV30> _iter86 : struct.delta_object_map.entrySet())
          {
      ...
      if (struct.json_metadata != null) {
        if (struct.isSetJson_metadata()) {
          oprot.writeFieldBegin(JSON_METADATA_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter88 : struct.json_metadata)
            {
  ...
  private static class FileMetaDataV30TupleScheme extends org.apache.thrift.scheme.TupleScheme<FileMetaDataV30> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, FileMetaDataV30 struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.version);
      {
        ...
        for (java.util.Map.Entry<java.lang.String, DeltaObjectV30> _iter90 : struct.delta_object_map.entrySet())
        {
      ...
      if (struct.isSetJson_metadata()) {
        {
          ...
          for (java.lang.String _iter92 : struct.json_metadata)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, FileMetaDataV30 struct) throws org.apache.thrift.TException {
      ...
      struct.setVersionIsSet(true);
      {
        ...
        struct.delta_object_map = new java.util.HashMap<java.lang.String,DeltaObjectV30>(2*_map94.size);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.json_metadata = new java.util.ArrayList<java.lang.String>(_list101.size);
