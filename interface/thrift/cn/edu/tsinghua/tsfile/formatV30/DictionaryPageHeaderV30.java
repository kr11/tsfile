...
public class DictionaryPageHeaderV30 implements org.apache.thrift.TBase<DictionaryPageHeaderV30, DictionaryPageHeaderV30._Fields>, java.io.Serializable, Cloneable, Comparable<DictionaryPageHeaderV30> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DictionaryPageHeaderV30");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new DictionaryPageHeaderV30StandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new DictionaryPageHeaderV30TupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DictionaryPageHeaderV30.class, metaDataMap);
  }

  public DictionaryPageHeaderV30() {
  }
   ...
   */
  public DictionaryPageHeaderV30(DictionaryPageHeaderV30 other) {
  ...
  public DictionaryPageHeaderV30 deepCopy() {
    return new DictionaryPageHeaderV30(this);
  }
   ...
   * Number of values in the dictionary *
   */
  public DictionaryPageHeaderV30 setNum_values(int num_values) {
    this.num_values = num_values;
    setNum_valuesIsSet(true);
    return this;
  }
   ...
   * @see EncodingV30
   */
  public DictionaryPageHeaderV30 setEncoding(EncodingV30 encoding) {
    this.encoding = encoding;
    return this;
  }
   ...
   * If true, the entries in the dictionary are sorted in ascending order *
   */
  public DictionaryPageHeaderV30 setIs_sorted(boolean is_sorted) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case IS_SORTED:
      if (value == null) {
        ...
        setIs_sorted((java.lang.Boolean)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof DictionaryPageHeaderV30)
      return this.equals((DictionaryPageHeaderV30)that);
    return false;
  }

  public boolean equals(DictionaryPageHeaderV30 that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetIs_sorted()) ? 131071 : 524287);
    if (isSetIs_sorted())
  ...
  @Override
  public int compareTo(DictionaryPageHeaderV30 other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIs_sorted()).compareTo(other.isSetIs_sorted());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIs_sorted()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("DictionaryPageHeaderV30(");
    boolean first = true;
  ...
  private static class DictionaryPageHeaderV30StandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public DictionaryPageHeaderV30StandardScheme getScheme() {
      return new DictionaryPageHeaderV30StandardScheme();
    }
  }

  private static class DictionaryPageHeaderV30StandardScheme extends org.apache.thrift.scheme.StandardScheme<DictionaryPageHeaderV30> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DictionaryPageHeaderV30 struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DictionaryPageHeaderV30 struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class DictionaryPageHeaderV30TupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public DictionaryPageHeaderV30TupleScheme getScheme() {
      return new DictionaryPageHeaderV30TupleScheme();
    }
  }

  private static class DictionaryPageHeaderV30TupleScheme extends org.apache.thrift.scheme.TupleScheme<DictionaryPageHeaderV30> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DictionaryPageHeaderV30 struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DictionaryPageHeaderV30 struct) throws org.apache.thrift.TException {
