...
public class TimeSeriesChunkMetaDataV30 implements org.apache.thrift.TBase<TimeSeriesChunkMetaDataV30, TimeSeriesChunkMetaDataV30._Fields>, java.io.Serializable, Cloneable, Comparable<TimeSeriesChunkMetaDataV30> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TimeSeriesChunkMetaDataV30");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TimeSeriesChunkMetaDataV30StandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TimeSeriesChunkMetaDataV30TupleSchemeFactory();
   ...
   * 
   * @see TimeSeriesChunkTypeV30
   */
  public TimeSeriesChunkTypeV30 timeseries_chunk_type; // required
  /**
   * Set of all encodings used for this time series. The purpose is to validate
   * whether we can decode those pages. *
   */
  public java.util.List<EncodingV30> encodings; // optional
  /**
  ...
  /**
   * 
   * @see CompressionTypeV30
   */
  public CompressionTypeV30 compression_type; // required
   ...
   */
  public java.util.List<java.lang.String> json_metadata; // optional
  /**
  ...
  public TimeInTimeSeriesChunkMetaDataV30 time_tsc; // optional
  public ValueInTimeSeriesChunkMetaDataV30 value_tsc; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.TIMESERIES_CHUNK_TYPE, new org.apache.thrift.meta_data.FieldMetaData("timeseries_chunk_type", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, TimeSeriesChunkTypeV30.class)));
    ...
    tmpMap.put(_Fields.COMPRESSION_TYPE, new org.apache.thrift.meta_data.FieldMetaData("compression_type", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, CompressionTypeV30.class)));
    ...
    tmpMap.put(_Fields.TIME_TSC, new org.apache.thrift.meta_data.FieldMetaData("time_tsc", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TimeInTimeSeriesChunkMetaDataV30.class)));
    tmpMap.put(_Fields.VALUE_TSC, new org.apache.thrift.meta_data.FieldMetaData("value_tsc", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ValueInTimeSeriesChunkMetaDataV30.class)));
    metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TimeSeriesChunkMetaDataV30.class, metaDataMap);
  }

  public TimeSeriesChunkMetaDataV30() {
  }

  public TimeSeriesChunkMetaDataV30(
    java.lang.String measurement_uid,
    TimeSeriesChunkTypeV30 timeseries_chunk_type,
    long file_offset,
    CompressionTypeV30 compression_type)
  {
    this();
   ...
   */
  public TimeSeriesChunkMetaDataV30(TimeSeriesChunkMetaDataV30 other) {
    ...
    if (other.isSetEncodings()) {
      java.util.List<EncodingV30> __this__encodings = new java.util.ArrayList<EncodingV30>(other.encodings.size());
      for (EncodingV30 other_element : other.encodings) {
    ...
    if (other.isSetJson_metadata()) {
      java.util.List<java.lang.String> __this__json_metadata = new java.util.ArrayList<java.lang.String>(other.json_metadata);
    ...
    if (other.isSetTime_tsc()) {
      this.time_tsc = new TimeInTimeSeriesChunkMetaDataV30(other.time_tsc);
    }
    if (other.isSetValue_tsc()) {
      this.value_tsc = new ValueInTimeSeriesChunkMetaDataV30(other.value_tsc);
    }
  }

  public TimeSeriesChunkMetaDataV30 deepCopy() {
    return new TimeSeriesChunkMetaDataV30(this);
  }
  ...
  public TimeSeriesChunkMetaDataV30 setMeasurement_uid(java.lang.String measurement_uid) {
    this.measurement_uid = measurement_uid;
    return this;
  }
   ...
   * Referenced field id in the TSFile schema *
   */
  public TimeSeriesChunkMetaDataV30 setRef_field_id(int ref_field_id) {
  ...
  public void unsetRef_field_id() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __REF_FIELD_ID_ISSET_ID);
  }

  /** Returns true if field ref_field_id is set (has been assigned a value) and false otherwise */
  public boolean isSetRef_field_id() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __REF_FIELD_ID_ISSET_ID);
  }

  public void setRef_field_idIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __REF_FIELD_ID_ISSET_ID, value);
  }
   ...
   * @see TimeSeriesChunkTypeV30
   */
  public TimeSeriesChunkTypeV30 getTimeseries_chunk_type() {
   ...
   * @see TimeSeriesChunkTypeV30
   */
  public TimeSeriesChunkMetaDataV30 setTimeseries_chunk_type(TimeSeriesChunkTypeV30 timeseries_chunk_type) {
    this.timeseries_chunk_type = timeseries_chunk_type;
    return this;
  }
  ...
  public java.util.Iterator<EncodingV30> getEncodingsIterator() {
    return (this.encodings == null) ? null : this.encodings.iterator();
  }

  public void addToEncodings(EncodingV30 elem) {
    if (this.encodings == null) {
      this.encodings = new java.util.ArrayList<EncodingV30>();
    }
   ...
   * whether we can decode those pages. *
   */
  public java.util.List<EncodingV30> getEncodings() {
   ...
   * whether we can decode those pages. *
   */
  public TimeSeriesChunkMetaDataV30 setEncodings(java.util.List<EncodingV30> encodings) {
   ...
   * Byte offset in file_path to the RowGroupMetaDataV30 *
   */
  public TimeSeriesChunkMetaDataV30 setFile_offset(long file_offset) {
    this.file_offset = file_offset;
    setFile_offsetIsSet(true);
    return this;
  }
   ...
   * @see CompressionTypeV30
   */
  public CompressionTypeV30 getCompression_type() {
   ...
   * @see CompressionTypeV30
   */
  public TimeSeriesChunkMetaDataV30 setCompression_type(CompressionTypeV30 compression_type) {
    this.compression_type = compression_type;
    return this;
  }
  ...
  public TimeSeriesChunkMetaDataV30 setNum_rows(long num_rows) {
   ...
   * total byte size of all uncompressed pages in this time series chunk (including the headers) *
   */
  public TimeSeriesChunkMetaDataV30 setTotal_byte_size(long total_byte_size) {
  ...
  public java.util.Iterator<java.lang.String> getJson_metadataIterator() {
    return (this.json_metadata == null) ? null : this.json_metadata.iterator();
  }

  public void addToJson_metadata(java.lang.String elem) {
    if (this.json_metadata == null) {
      this.json_metadata = new java.util.ArrayList<java.lang.String>();
    }
   ...
   * Optional json metadata *
   */
  public java.util.List<java.lang.String> getJson_metadata() {
   ...
   * Optional json metadata *
   */
  public TimeSeriesChunkMetaDataV30 setJson_metadata(java.util.List<java.lang.String> json_metadata) {
   ...
   * Byte offset from beginning of file to first data page *
   */
  public TimeSeriesChunkMetaDataV30 setData_page_offset(long data_page_offset) {
   ...
   * Byte offset from beginning of file to root index page *
   */
  public TimeSeriesChunkMetaDataV30 setIndex_page_offset(long index_page_offset) {
   ...
   * Byte offset from the beginning of file to first (only) dictionary page *
   */
  public TimeSeriesChunkMetaDataV30 setDictionary_page_offset(long dictionary_page_offset) {
   ...
   * optional digest/statistics for this timeseries chunk
   */
  public TimeSeriesChunkMetaDataV30 setDigest(DigestV30 digest) {
    this.digest = digest;
    return this;
  }
  ...
  public TimeInTimeSeriesChunkMetaDataV30 getTime_tsc() {
    return this.time_tsc;
  }

  public TimeSeriesChunkMetaDataV30 setTime_tsc(TimeInTimeSeriesChunkMetaDataV30 time_tsc) {
  ...
  public ValueInTimeSeriesChunkMetaDataV30 getValue_tsc() {
    return this.value_tsc;
  }

  public TimeSeriesChunkMetaDataV30 setValue_tsc(ValueInTimeSeriesChunkMetaDataV30 value_tsc) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case REF_FIELD_ID:
      if (value == null) {
        ...
        setRef_field_id((java.lang.Integer)value);
      }
      break;
    ...
    case TIMESERIES_CHUNK_TYPE:
      if (value == null) {
        ...
        setTimeseries_chunk_type((TimeSeriesChunkTypeV30)value);
      }
      break;
    ...
    case ENCODINGS:
      if (value == null) {
        ...
        setEncodings((java.util.List<EncodingV30>)value);
      }
      break;
    ...
    case COMPRESSION_TYPE:
      if (value == null) {
        ...
        setCompression_type((CompressionTypeV30)value);
      }
      break;
    ...
    case JSON_METADATA:
      if (value == null) {
        ...
        setJson_metadata((java.util.List<java.lang.String>)value);
      }
      break;
    ...
    case TIME_TSC:
      if (value == null) {
        ...
        setTime_tsc((TimeInTimeSeriesChunkMetaDataV30)value);
      }
      break;
    ...
    case VALUE_TSC:
      if (value == null) {
        ...
        setValue_tsc((ValueInTimeSeriesChunkMetaDataV30)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TimeSeriesChunkMetaDataV30)
      return this.equals((TimeSeriesChunkMetaDataV30)that);
    return false;
  }

  public boolean equals(TimeSeriesChunkMetaDataV30 that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TimeSeriesChunkMetaDataV30 other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetRef_field_id()).compareTo(other.isSetRef_field_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTimeseries_chunk_type()).compareTo(other.isSetTimeseries_chunk_type());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetEncodings()).compareTo(other.isSetEncodings());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEncodings()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCompression_type()).compareTo(other.isSetCompression_type());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetJson_metadata()).compareTo(other.isSetJson_metadata());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetData_page_offset()).compareTo(other.isSetData_page_offset());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIndex_page_offset()).compareTo(other.isSetIndex_page_offset());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDictionary_page_offset()).compareTo(other.isSetDictionary_page_offset());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTime_tsc()).compareTo(other.isSetTime_tsc());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTime_tsc()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetValue_tsc()).compareTo(other.isSetValue_tsc());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetValue_tsc()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TimeSeriesChunkMetaDataV30(");
    boolean first = true;
  ...
  private static class TimeSeriesChunkMetaDataV30StandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TimeSeriesChunkMetaDataV30StandardScheme getScheme() {
      return new TimeSeriesChunkMetaDataV30StandardScheme();
    }
  }

  private static class TimeSeriesChunkMetaDataV30StandardScheme extends org.apache.thrift.scheme.StandardScheme<TimeSeriesChunkMetaDataV30> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TimeSeriesChunkMetaDataV30 struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // TIMESERIES_CHUNK_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.timeseries_chunk_type = cn.edu.tsinghua.tsfile.formatV30.TimeSeriesChunkTypeV30.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.encodings = new java.util.ArrayList<EncodingV30>(_list24.size);
                EncodingV30 _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = cn.edu.tsinghua.tsfile.formatV30.EncodingV30.findByValue(iprot.readI32());
                  if (_elem25 != null)
                  {
          ...
          case 6: // COMPRESSION_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.compression_type = cn.edu.tsinghua.tsfile.formatV30.CompressionTypeV30.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.json_metadata = new java.util.ArrayList<java.lang.String>(_list27.size);
                java.lang.String _elem28;
                for (int _i29 = 0; _i29 < _list27.size; ++_i29)
                {
                  _elem28 = iprot.readString();
                  struct.json_metadata.add(_elem28);
                }
                iprot.readListEnd();
              }
          ...
          case 14: // TIME_TSC
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.time_tsc = new TimeInTimeSeriesChunkMetaDataV30();
          ...
          case 15: // VALUE_TSC
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.value_tsc = new ValueInTimeSeriesChunkMetaDataV30();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TimeSeriesChunkMetaDataV30 struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.encodings != null) {
        if (struct.isSetEncodings()) {
          oprot.writeFieldBegin(ENCODINGS_FIELD_DESC);
          {
            ...
            for (EncodingV30 _iter30 : struct.encodings)
            {
      ...
      if (struct.json_metadata != null) {
        if (struct.isSetJson_metadata()) {
          oprot.writeFieldBegin(JSON_METADATA_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter31 : struct.json_metadata)
            {
  ...
  private static class TimeSeriesChunkMetaDataV30TupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TimeSeriesChunkMetaDataV30TupleScheme getScheme() {
      return new TimeSeriesChunkMetaDataV30TupleScheme();
    }
  }

  private static class TimeSeriesChunkMetaDataV30TupleScheme extends org.apache.thrift.scheme.TupleScheme<TimeSeriesChunkMetaDataV30> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TimeSeriesChunkMetaDataV30 struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetEncodings()) {
        {
          ...
          for (EncodingV30 _iter32 : struct.encodings)
          {
      ...
      if (struct.isSetJson_metadata()) {
        {
          ...
          for (java.lang.String _iter33 : struct.json_metadata)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TimeSeriesChunkMetaDataV30 struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.encodings = new java.util.ArrayList<EncodingV30>(_list34.size);
          EncodingV30 _elem35;
          for (int _i36 = 0; _i36 < _list34.size; ++_i36)
          {
            _elem35 = cn.edu.tsinghua.tsfile.formatV30.EncodingV30.findByValue(iprot.readI32());
            if (_elem35 != null)
            {
              struct.encodings.add(_elem35);
            }
          }
        }
        struct.setEncodingsIsSet(true);
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.json_metadata = new java.util.ArrayList<java.lang.String>(_list37.size);
          java.lang.String _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = iprot.readString();
            struct.json_metadata.add(_elem38);
          }
        }
        struct.setJson_metadataIsSet(true);
      }
