...
public class RowGroupBlockMetaDataV30 implements org.apache.thrift.TBase<RowGroupBlockMetaDataV30, RowGroupBlockMetaDataV30._Fields>, java.io.Serializable, Cloneable, Comparable<RowGroupBlockMetaDataV30> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new RowGroupBlockMetaDataV30StandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new RowGroupBlockMetaDataV30TupleSchemeFactory();

  public java.util.List<RowGroupMetaDataV30> row_groups_metadata; // required
  public java.lang.String delta_object_id; // optional
  ...
  public RowGroupBlockMetaDataV30(
    java.util.List<RowGroupMetaDataV30> row_groups_metadata)
  {
    this();
  ...
  public RowGroupBlockMetaDataV30(RowGroupBlockMetaDataV30 other) {
    if (other.isSetRow_groups_metadata()) {
      java.util.List<RowGroupMetaDataV30> __this__row_groups_metadata = new java.util.ArrayList<RowGroupMetaDataV30>(other.row_groups_metadata.size());
  ...
  public void addToRow_groups_metadata(RowGroupMetaDataV30 elem) {
    if (this.row_groups_metadata == null) {
      this.row_groups_metadata = new java.util.ArrayList<RowGroupMetaDataV30>();
    }
    this.row_groups_metadata.add(elem);
  }

  public java.util.List<RowGroupMetaDataV30> getRow_groups_metadata() {
    return this.row_groups_metadata;
  }

  public RowGroupBlockMetaDataV30 setRow_groups_metadata(java.util.List<RowGroupMetaDataV30> row_groups_metadata) {
    this.row_groups_metadata = row_groups_metadata;
    return this;
  }
  ...
  public RowGroupBlockMetaDataV30 setDelta_object_id(java.lang.String delta_object_id) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case ROW_GROUPS_METADATA:
      if (value == null) {
        ...
        setRow_groups_metadata((java.util.List<RowGroupMetaDataV30>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetRow_groups_metadata()) ? 131071 : 524287);
    if (isSetRow_groups_metadata())
      hashCode = hashCode * 8191 + row_groups_metadata.hashCode();
  ...
  public int compareTo(RowGroupBlockMetaDataV30 other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetRow_groups_metadata()).compareTo(other.isSetRow_groups_metadata());
    if (lastComparison != 0) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("RowGroupBlockMetaDataV30(");
    boolean first = true;
  ...
  private static class RowGroupBlockMetaDataV30StandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public RowGroupBlockMetaDataV30StandardScheme getScheme() {
      return new RowGroupBlockMetaDataV30StandardScheme();
    }
  }

  private static class RowGroupBlockMetaDataV30StandardScheme extends org.apache.thrift.scheme.StandardScheme<RowGroupBlockMetaDataV30> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.row_groups_metadata = new java.util.ArrayList<RowGroupMetaDataV30>(_list48.size);
                RowGroupMetaDataV30 _elem49;
                for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                {
                  _elem49 = new RowGroupMetaDataV30();
                  _elem49.read(iprot);
  ...
  private static class RowGroupBlockMetaDataV30TupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public RowGroupBlockMetaDataV30TupleScheme getScheme() {
      return new RowGroupBlockMetaDataV30TupleScheme();
    }
  }

  private static class RowGroupBlockMetaDataV30TupleScheme extends org.apache.thrift.scheme.TupleScheme<RowGroupBlockMetaDataV30> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, RowGroupBlockMetaDataV30 struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.row_groups_metadata = new java.util.ArrayList<RowGroupMetaDataV30>(_list53.size);
        RowGroupMetaDataV30 _elem54;
        for (int _i55 = 0; _i55 < _list53.size; ++_i55)
        {
          _elem54 = new RowGroupMetaDataV30();
          _elem54.read(iprot);
