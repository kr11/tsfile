...
public class PageHeaderV30 implements org.apache.thrift.TBase<PageHeaderV30, PageHeaderV30._Fields>, java.io.Serializable, Cloneable, Comparable<PageHeaderV30> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new PageHeaderV30StandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new PageHeaderV30TupleSchemeFactory();
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case UNCOMPRESSED_PAGE_SIZE:
      if (value == null) {
        ...
        setUncompressed_page_size((java.lang.Integer)value);
      }
      break;
    ...
    case COMPRESSED_PAGE_SIZE:
      if (value == null) {
        ...
        setCompressed_page_size((java.lang.Integer)value);
      }
      break;
  ...
  public java.lang.Object getFieldValue(_Fields field) {
    ...
    case UNCOMPRESSED_PAGE_SIZE:
      return getUncompressed_page_size();

    case COMPRESSED_PAGE_SIZE:
      return getCompressed_page_size();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetData_page_header()) ? 131071 : 524287);
    if (isSetData_page_header())
      hashCode = hashCode * 8191 + data_page_header.hashCode();

    hashCode = hashCode * 8191 + ((isSetIndex_page_header()) ? 131071 : 524287);
    if (isSetIndex_page_header())
      hashCode = hashCode * 8191 + index_page_header.hashCode();

    hashCode = hashCode * 8191 + ((isSetDictionary_page_header()) ? 131071 : 524287);
  ...
  public int compareTo(PageHeaderV30 other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetUncompressed_page_size()).compareTo(other.isSetUncompressed_page_size());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCompressed_page_size()).compareTo(other.isSetCompressed_page_size());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCrc()).compareTo(other.isSetCrc());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCrc()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetData_page_header()).compareTo(other.isSetData_page_header());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetData_page_header()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIndex_page_header()).compareTo(other.isSetIndex_page_header());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIndex_page_header()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDictionary_page_header()).compareTo(other.isSetDictionary_page_header());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDictionary_page_header()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("PageHeaderV30(");
    boolean first = true;
  ...
  private static class PageHeaderV30StandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public PageHeaderV30StandardScheme getScheme() {
      return new PageHeaderV30StandardScheme();
    }
  }

  private static class PageHeaderV30StandardScheme extends org.apache.thrift.scheme.StandardScheme<PageHeaderV30> {
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = cn.edu.tsinghua.tsfile.formatV30.PageTypeV30.findByValue(iprot.readI32());
  ...
  private static class PageHeaderV30TupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public PageHeaderV30TupleScheme getScheme() {
      return new PageHeaderV30TupleScheme();
    }
  }

  private static class PageHeaderV30TupleScheme extends org.apache.thrift.scheme.TupleScheme<PageHeaderV30> {
