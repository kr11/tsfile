...
public class DigestV30 implements org.apache.thrift.TBase<DigestV30, DigestV30._Fields>, java.io.Serializable, Cloneable, Comparable<DigestV30> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DigestV30");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new DigestV30StandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new DigestV30TupleSchemeFactory();

  /**
   * min and max value of the timeseries, encoded in PLAIN encoding
   */
  public java.nio.ByteBuffer max; // optional
  public java.nio.ByteBuffer min; // optional
  /**
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DigestV30.class, metaDataMap);
  }
   ...
   */
  public DigestV30(DigestV30 other) {
  ...
  public DigestV30 deepCopy() {
    return new DigestV30(this);
  }
   ...
   * min and max value of the timeseries, encoded in PLAIN encoding
   */
  public DigestV30 setMax(byte[] max) {
    this.max = max == null ? (java.nio.ByteBuffer)null : java.nio.ByteBuffer.wrap(max.clone());
    return this;
  }

  public DigestV30 setMax(java.nio.ByteBuffer max) {
  ...
  public DigestV30 setMin(byte[] min) {
    this.min = min == null ? (java.nio.ByteBuffer)null : java.nio.ByteBuffer.wrap(min.clone());
    return this;
  }

  public DigestV30 setMin(java.nio.ByteBuffer min) {
   ...
   * count of null value in the timeseries
   */
  public DigestV30 setNull_count(long null_count) {
   ...
   * count of distinct values occurring
   */
  public DigestV30 setDistinct_count(long distinct_count) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case NULL_COUNT:
      if (value == null) {
        ...
        setNull_count((java.lang.Long)value);
      }
      break;
    ...
    case DISTINCT_COUNT:
      if (value == null) {
        ...
        setDistinct_count((java.lang.Long)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof DigestV30)
      return this.equals((DigestV30)that);
    return false;
  }

  public boolean equals(DigestV30 that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
...
//
//    hashCode = hashCode * 8191 + ((isSetNull_count()) ? 131071 : 524287);
//    if (isSetNull_count())
//      hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(null_count);
//
//    hashCode = hashCode * 8191 + ((isSetDistinct_count()) ? 131071 : 524287);
...
//    return hashCode;
  ...
  @Override
  public int compareTo(DigestV30 other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetNull_count()).compareTo(other.isSetNull_count());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNull_count()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDistinct_count()).compareTo(other.isSetDistinct_count());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDistinct_count()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("DigestV30(");
    boolean first = true;
  ...
  private static class DigestV30StandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public DigestV30StandardScheme getScheme() {
      return new DigestV30StandardScheme();
    }
  }

  private static class DigestV30StandardScheme extends org.apache.thrift.scheme.StandardScheme<DigestV30> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DigestV30 struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DigestV30 struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class DigestV30TupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public DigestV30TupleScheme getScheme() {
      return new DigestV30TupleScheme();
    }
  }

  private static class DigestV30TupleScheme extends org.apache.thrift.scheme.TupleScheme<DigestV30> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DigestV30 struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DigestV30 struct) throws org.apache.thrift.TException {
