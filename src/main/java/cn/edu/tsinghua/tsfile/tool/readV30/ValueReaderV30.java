 ...
 * in different ways.
 */
public class ValueReaderV30 {

    private static final Logger log = LoggerFactory.getLogger(cn.edu.tsinghua.tsfile.timeseries.read.ValueReader.class);
     ...
     */
    public ValueReaderV30(long offset, long totalSize, TSDataType dataType, TsDigest digest) {
    ...
    public ValueReaderV30(long offset, long totalSize, TSDataType dataType, TsDigest digest, ITsRandomAccessFileReader raf,
